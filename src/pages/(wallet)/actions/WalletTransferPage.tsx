    ...
    <div className="relative flex-1 flex flex-col gap-6">
      ...
      <Tabs defaultValue="single" className="flex-1">
        <TabsList className="w-full">
          <TabsTrigger value="single" className="w-full text-sm px-2">
            {t('transfer.tabs.single')}
          </TabsTrigger>
          <TabsTrigger value="multiple" className="w-full text-sm px-2">
            {t('transfer.tabs.multiple')}
          </TabsTrigger>
        </TabsList>
