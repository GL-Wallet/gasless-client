...
export function WalletManagerDrawer() {
  ...
  const { walletName, activeIndex, addresses, setActiveWallet }
  ...
  const MemoizedDrawerTrigger = React.memo(
    ({ onClick, walletName }: { onClick: () => void, walletName: string }) => (
  ...
  return (
    <Drawer open={isOpened} onOpenChange={setIsOpened}>
      <MemoizedDrawerTrigger
        onClick={handleOpenDrawer}
        walletName={memoizedWalletName!}
      />
